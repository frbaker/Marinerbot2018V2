...
std::shared_ptr<frc::PowerDistributionPanel> RobotMap::powerDistPowerDistributionPanel1;
...
std::shared_ptr<frc::SpeedController> RobotMap::elevatorElevatorSpark;
...
void RobotMap::init() {
    ...
    powerDistPowerDistributionPanel1.reset(new frc::PowerDistributionPanel(0));
    lw->AddSensor("PowerDist", "PowerDistributionPanel 1", powerDistPowerDistributionPanel1);
    ...
    elevatorElevatorSpark.reset(new frc::Spark(0));
    lw->AddActuator("Elevator", "Elevator Spark", std::static_pointer_cast<frc::Spark>(elevatorElevatorSpark));
